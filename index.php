...
<body>
    ...
    <div class="sidebar">
        <div class="sidebar__content">
            ...
            <nav class="nav-links">
                <a href="./index.php#projects" class="nav-links__link"><i class="fa-solid fa-wrench nav-links__icon"></i>Projects</a>
                ...
                <a href="./index.php#contact" class="nav-links__link"><i class="fa-solid fa-message nav-links__icon"></i>Contact</a>
            </nav>
            <div class="socials">
