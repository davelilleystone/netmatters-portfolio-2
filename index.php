...
<body>
    ...
    <div class="sidebar">
        <div class="sidebar__content">
            ...
            <nav class="nav-links">
                <a href="./index.html#projects" class="nav-links__link"><i
                ...
                <a href="./scs.html" class="nav-links__link"><i
                        class="fa-solid fa-graduation-cap nav-links__icon"></i>SCS</a>
                <a href="./about.html" class="nav-links__link"><i class="fa-solid fa-user nav-links__icon"></i>About</a>
                <a href="./index.html#contact" class="nav-links__link"><i
                        class="fa-solid fa-message nav-links__icon"></i>Contact</a>
            </nav>
            <div class="socials">
                <a href="https://github.com/davelilleystone/" class="socials__link" target="_blank"><i
                        class="fa-brands fa-square-github socials__icon socials__icon--github"></i></a>
                <a href="https://www.linkedin.com/in/david-lilleystone/" class="socials__link" target="_blank"><i
                        class="fa-brands fa-linkedin socials__icon socials__icon--linkedin"></i></a>
                <a href="https://twitter.com/super_hammerman/" class="socials__link" target="_blank"><i
        ...
        <div class="content-wrapper">
            <div class="projects" id="projects">
                ...
                <div class="card-container">
                    <div class="card">
                        <picture><img class="card__image" src="./img/projects/project-1-img.webp"
                                alt="netmatters project" />
                        </picture>
                        <h3 class="card__title">Netmatters</h3>
                        <div class="card__technologies">
                            <span class="card__technology card__technology--html">HTML</span><span
                                class="card__technology card__technology--css">CSS</span><span
                                class="card__technology card__technology--js">JS</span><span
                                class="card__technology card__technology--sass">SASS</span>
                        </div>
                        <p class="card__text">
                        ...
                        <div class="card__buttons">
                            <a href="https://netmatters.dave-lilleystone.netmatters-scs.co.uk/" class="card__button"
                                target="_blank">view site</a>
                            <a href="https://github.com/davelilleystone/netmatters-site-replication"
                                class="card__button" target="_blank">view code</a>
                        </div>
                    </div>
                    <div class="card">
                        <picture><img class="card__image" src="./img/projects/project-2-img.webp"
                                alt="netmatters project" />
                        </picture>
                        ...
                        <div class="card__buttons">
                            <a href="https://js-array.dave-lilleystone.netmatters-scs.co.uk/" class="card__button"
                                target="_blank">view site</a>
                            <a href="https://github.com/davelilleystone/netmatters-js-array" class="card__button"
                                target="_blank">view
                                code</a>
                        </div>
                    </div>
                ...
                <div class="contact-text">
                    ...
                    <div class="contact-text__text-wrapper">
                        ...
                        <p class="contact-text__paragraph">
                            ...
                            available via
                            email on
                            <strong><a href="mailto:dave@dplwebdesign.co.uk"
                                    target="_blank">dave@dplwebdesign.co.uk.</a></strong>
                        </p>
